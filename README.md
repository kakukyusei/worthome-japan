...
- **プライマリーカラー**: #003366 (コーポレートダークブルー)
- **セカンダリーカラー**: #0066cc (ブライトブルー)
- **アクセントカラー**: #dc2626 (レッド)
...
大同特殊鋼と青山鋼鉄を参考にしたコーポレート・インダストリアルデザイン:
- **ホワイトナビゲーションバー**: 企業の信頼性と清潔感を表現
- **背景画像統合**: 15枚の製鉄所写真をヒーローセクション、ページヘッダー、CTAセクションに配置
- **グラデーションオーバーレイ**: 写真と文字の視認性を確保しながら、プロフェッショナルな印象を演出
