...
- **プライマリーカラー**: #c41e3a (大同特殊鋼レッド)
- **セカンダリーカラー**: #8b0000 (ダークレッド)
- **ダークカラー**: #2d2d2d (ダークグレー)
- **テキストカラー**: #333333 (テキストグレー)
- **背景カラー**: #ffffff (クリーンホワイト)

### デザインコンセプト

大同特殊鋼を参考にしたコーポレート・インダストリアルデザイン:
- **レッド・グレー・ホワイト配色**: 大同特殊鋼の企業カラーを採用し、信頼性と情熱を表現
- **WORTHOMEロゴ統合**: ナビゲーションバー左上にブランドロゴを配置
- **ホワイトナビゲーションバー**: 清潔感とプロフェッショナルさを演出
- **背景画像統合**: 製鉄所写真をヒーローセクション、ページヘッダー、CTAセクションに配置
- **グラデーションオーバーレイ**: ダークグレーとレッドの組み合わせで視認性と力強さを両立
- **改善されたタイポグラフィ**: より良いスペーシングと階層構造
- **洗練されたカードデザイン**: 微妙な影とボーダーで深みを表現
